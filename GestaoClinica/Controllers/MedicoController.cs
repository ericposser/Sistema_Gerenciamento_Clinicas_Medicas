...
namespace GestaoClinica.Controllers
{
    public class MedicoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CRM,Telefone")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CRM,Telefone")] Medico medico)
        {
            if (id != medico.Id)
            {
                return NotFound();
